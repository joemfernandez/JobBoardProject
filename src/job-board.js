var JobBoardApp = (function ($) {
    ...
    var UIController = {
        ...
        setupModal: function (config) {
            ...
            $(window).off('click.jobmodal').on('click.jobmodal', function (event) {
        ...
        initTable: function (config, data) {
                ...
                columns: [
                    ...
                    { data: "Grade" },
                    {
                        ...
                        render: function (data, type, row) {
                            ...
                            return '<button class="job-view-btn" type="button">' + data + '</button>';
                        }
                    }
                ],
            ...
            $(config.tableSelector + ' tbody').on('click', '.job-view-btn', function () {
